...
//                 <strong>{resumeData?.scores?.final ?? 0}%</strong>
//               </div>
//             </div>
...
//       if (!res.data.valid) {
//         setResumeError(res.data.message || "Invalid resume");
//         setStage("idle");
//         return;
//       }
          ...
          <>
            ...
            <div className="analysis-summary">
              <div>
                <h4>Resume Analysis</h4>
                <p>
                  Skills Found: {resumeData?.skills?.length ?? 0}
                </p>
              </div>
              <div className="score-text">
                <strong>{resumeData?.scores?.final ?? 0}%</strong>
            ...
            <div className="result-box">
              <h4>Score Breakdown</h4>
              <p>Skills Match: {resumeData?.scores?.skills ?? 0}%</p>
              <p>Experience: {resumeData?.scores?.experience ?? 0}%</p>
              <p>Content Quality: {resumeData?.scores?.content ?? 0}%</p>
            </div>
